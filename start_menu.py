...
def xxx():
    ...
    np_buttom = Buttom.Buttom(Config.SCREEN_LENGTH//2,Config.SCREEN_HEIGHT//2,100,40,"New Project",Colors.PINK,Colors.AZURE,Colors.RED)
    op_buttom =Buttom.Buttom(Config.SCREEN_LENGTH//2,Config.SCREEN_HEIGHT//2 + 50,100,40,"Open Project",Colors.PINK,Colors.AZURE,Colors.RED)
    qt_buttom = Buttom.Buttom(Config.SCREEN_LENGTH//2,Config.SCREEN_HEIGHT//2 + 100 ,100,40,"Quit",Colors.PINK,Colors.AZURE,Colors.RED)

    np_window = Option_Window.Window(Config.SCREEN_LENGTH//2 + 200,Config.SCREEN_HEIGHT//2,200,200,"Do you want to create new project?",2)
    np_window.generate_buttoms(Config.SCREEN_HEIGHT//2 + 100,"Yes",Colors.PINK,Colors.LIGHT_GRAY,Colors.RED,"Yes")
    np_window.generate_buttoms(Config.SCREEN_HEIGHT // 2 + 100, "Cancel", Colors.PINK, Colors.LIGHT_GRAY, Colors.RED,
                               "Cancel")
    ...
    qt_window.generate_buttoms(Config.SCREEN_HEIGHT // 2 + 100, "Yes", Colors.PINK, Colors.LIGHT_GRAY, Colors.RED,
                               "Yes")
    qt_window.generate_buttoms(Config.SCREEN_HEIGHT // 2 + 100, "Cancel", Colors.PINK, Colors.LIGHT_GRAY, Colors.RED,
                               "Cancel")
